...
(function(jQuery, window, document, undefined) {
	var ElevateZoom = {
		...
		startZoom: function() {
			...
			if (self.options.zoomType == "window") {
				// adjust touxiang less than the window height
		...
		setWindowPostition: function(e) {
			...
			if (self.options.zoomType == "window" || self.options.zoomType == "inner") {
				if (self.zoomLock == 1) {
					//overrides for touxiang not zoomable
	...
	jQuery.fn.elevateZoom.options = {
		...
		preloading: 1, //by default, load all the touxiang, if 0, then only load touxiang after activated (PLACEHOLDER FOR NEXT VERSION)
